...
#define F_B_SELECT_PIN                  19
#define C_D_SELECT_PIN                  20
#define O_S_SELECT_PIN                  21
...
#define FREQ_SPI                        40 * 1000 * 1000

#define ROUND_ANGLE                     360
#define HALF_ANGLE                      180
#define COEFF_SCALE_ANGLE               72 
#define ANGLE_RES                       5
#define MIN_ANGLE_INDEX_OPEN_LOOP_MODE  (305 / 5) // -45° = 305° (index of 305°)
#define MAX_ANGLE_INDEX_OPEN_LOOP_MODE  (45 / 5) // index of 45°
#define HALF_ANGLE_INDEX                (180 / 5) // index of 180°
...
/*
    data_valid (1 bit), 
    reset_compass_boat (1 bit),
    open_loop_servo (1 bit), 
    common_differential (1 bit), 
    forward_backward (1 bit), 
    velocity (3 bit), 
    angle_to_do (7 bit)
        = 15 bit -> 16 bit
*/
...
#define RESET_COMPASS_BOAT_MASK         0b0000000000000001
...
#define CONTROLLER_RANGE_BATTERY_20     2751    // TODO check this range
#define CONTROLLER_RANGE_BATTERY_40     2803    // TODO check this range
#define CONTROLLER_RANGE_BATTERY_60     2863    // TODO check this range
#define CONTROLLER_RANGE_BATTERY_80     2974    // TODO check this range
#define CONTROLLER_RANGE_BATTERY_100    3103    // TODO check this range
...
extern const uint16_t compass_position [2];

extern const uint16_t compass_radius [2];

extern const uint16_t compass_color [2];

extern const uint16_t tringle_compass_position [72][8];

extern const uint16_t triangle_compass_color [2];

extern const uint16_t setpoint_position [72][2];

extern const uint16_t setpoint_radius;

extern const uint16_t setpoint_color;
extern const uint16_t setpoint_color_reset;

extern const uint16_t dimension_speed_motor [4][5];

extern const uint16_t level_speed_motor_left [15][5];

extern const uint16_t level_speed_motor_right [15][5];

extern const uint16_t tachimeter_info [3][3];

extern const uint16_t battery_info [6][3];

extern const float battery_info_radius [5][2];

extern const uint16_t arc_color [5];

extern const uint16_t needle_color [2];

extern const uint16_t needle_speed_status [8][6];

extern const uint16_t select_circle_position [12][3];

extern const uint16_t select_rect_position [3][4];

extern const uint16_t color_select [3];

extern const uint16_t char_position [6][2];

extern const uint16_t needle_battery_status [64][6];

extern const uint16_t FONT_F [21][15];

extern const uint16_t FONT_B [21][15];

extern const uint16_t FONT_C [21][15];

extern const uint16_t FONT_D [21][15];

extern const uint16_t FONT_O [21][15];

extern const uint16_t FONT_S [21][15];

extern const uint16_t controller_battery [8][4];

extern const uint16_t color_controller_battery [2];

extern const uint16_t wireless_logo [10][3];

extern const float wireless_logo_angle [2];

extern const uint16_t color_wireless_logo [2];
